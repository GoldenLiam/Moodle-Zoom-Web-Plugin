...
function websdkready() {
  ...
  var meetingConfig = {
    ...
    leaveUrl: testTool.getCookie("leave_url"),
  ...
  if (meetingConfig.china)
    ZoomMtg.setZoomJSLib("https://jssdk.zoomus.cn/3.9.0/lib", "/av"); // china cdn option
  ...
  function beginJoin(signature) {
    ...
    ZoomMtg.init({
      ...
      externalLinkPage: "/mod/ttthzoom/external_link_page_iframe.php",
      success: function() {
